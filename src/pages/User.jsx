  ...
  return (
    <>
      <div className="w-full mx-auto lg:w-10/12">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-2 mbd-8 md:gap-8">
          ...
          <div className="col-span-2">
            <div className="mb-6">
              ...
              <div className="mt-4 card-actions">
                <a hred = {html_url} target = '_blank '
                rel = 'noreferrer' className='btn btn-outline'> 
                  Visit Github Profile
                </a>
              </div>
            </div>
            <div className="w-full rounded0lg shadow-md gb-base-100 stats">
              {location && (
                <div className="stat">
                  <div className="stat-title text-md">Location
                  </div>
                  <div className="stat-lg stat-value">
                    {location}
                  </div>
                </div>
              )}
              ...
              {twitter_username && (
                <div className="stat">
                  ...
                  <div className="stat-lg stat-value">
                    <a href={`https://twitter.com/${twitter_username}`} target= "_blank" rel='noreffer'>
                      {twitter_username}
                    </a>
                  </div>
                </div>
